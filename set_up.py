...
Original file is located at
    https://colab.research.google.com/drive/1xsX7LEDKL5S0gJSTN6e4J3hobW-eUx_c
"""
...
# create folders
!mkdir -p data/clean data/adv data/val_clean data/val_adv data/test_clean data/test_adv
# copy images here (use gsutil or git lfs or upload)